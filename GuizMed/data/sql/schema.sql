...
CREATE TABLE ad_non_psycho_pat (non_psycho_pat_id INT AUTO_INCREMENT, user_patient_id INT NOT NULL, non_psycho_id INT NOT NULL, start_date DATETIME NOT NULL, stop_date DATETIME, INDEX non_psycho_id_idx (non_psycho_id), INDEX user_patient_id_idx (user_patient_id), PRIMARY KEY(non_psycho_pat_id)) ENGINE = INNODB;
...
CREATE TABLE ad_prescription (ad_presc_id INT AUTO_INCREMENT, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, presc_date DATETIME NOT NULL, dose VARCHAR(45) NOT NULL, frequency VARCHAR(45) NOT NULL, user_patient_id INT NOT NULL, med_form_id INT NOT NULL, comment LONGBLOB, stop_date DATETIME, stop_reason VARCHAR(45), INDEX med_form_id_idx (med_form_id), INDEX user_patient_id_idx (user_patient_id), PRIMARY KEY(ad_presc_id)) ENGINE = INNODB;
CREATE TABLE ad_role (role_id INT AUTO_INCREMENT, name VARCHAR(45) NOT NULL, PRIMARY KEY(role_id)) ENGINE = INNODB;
CREATE TABLE ad_user (user_id INT AUTO_INCREMENT, fname VARCHAR(45) NOT NULL, lname VARCHAR(45) NOT NULL, email VARCHAR(80), uname VARCHAR(45) NOT NULL, passw VARCHAR(45) NOT NULL, phone VARCHAR(45), ad_role_id INT NOT NULL, ad_function_id INT NOT NULL, unlock_code VARCHAR(50), token VARCHAR(45), INDEX ad_function_id_idx (ad_function_id), INDEX ad_role_id_idx (ad_role_id), PRIMARY KEY(user_id)) ENGINE = INNODB;
CREATE TABLE ad_user_patient (user_patient_id INT AUTO_INCREMENT, patient_id INT NOT NULL, user_id INT NOT NULL, prev_user_id INT, active TINYINT DEFAULT '1' NOT NULL, denied TINYINT DEFAULT '0', INDEX patient_id_idx (patient_id), INDEX prev_user_id_idx (prev_user_id), INDEX user_id_idx (user_id), PRIMARY KEY(user_patient_id)) ENGINE = INNODB;
CREATE TABLE int_drug (int_drug_id INT, name VARCHAR(45) NOT NULL, minor_less_potent TINYINT, potent TINYINT, pro_drug TINYINT, substrate TINYINT, inhibitor TINYINT, inducer TINYINT, brand_id INT, int_enzym_id INT NOT NULL, enzym_subgroup_id INT, INDEX brand_id_idx (brand_id), INDEX enzym_subgroup_id_idx (enzym_subgroup_id), INDEX int_enzym_id_idx (int_enzym_id), PRIMARY KEY(int_drug_id)) ENGINE = INNODB;
...
CREATE TABLE int_interaction (int_interaction_id INT AUTO_INCREMENT, med_form_id INT NOT NULL, enzym_group_id INT NOT NULL, interaction_type INT NOT NULL, int_enzym_id INT NOT NULL, INDEX enzym_group_id_idx (enzym_group_id), INDEX int_enzym_id_idx (int_enzym_id), INDEX med_form_id_idx (med_form_id), PRIMARY KEY(int_interaction_id)) ENGINE = INNODB;
CREATE TABLE int_metabolism (int_metabolism_id INT, med_form_id INT NOT NULL, enzym_group_id INT NOT NULL, interaction_type VARCHAR(10), INDEX enzym_group_id_idx (enzym_group_id), INDEX med_form_id_idx (med_form_id), PRIMARY KEY(int_metabolism_id)) ENGINE = INNODB;
...
CREATE TABLE medicijn (id BIGINT AUTO_INCREMENT, hoofdklasse VARCHAR(255) NOT NULL, generische_naam VARCHAR(255) NOT NULL, specialiteit VARCHAR(255) NOT NULL, magistraat_type VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, bnf_percentage BIGINT NOT NULL, bnf_getal BIGINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE patient (id BIGINT AUTO_INCREMENT, naam VARCHAR(255) NOT NULL, voornaam VARCHAR(255) NOT NULL, geslacht TINYINT NOT NULL, geboortedatum VARCHAR(255), medicatiescheme VARCHAR(255), opmerkingen TEXT, voorgeschiedenis TEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
...
ALTER TABLE ad_non_psycho_pat ADD CONSTRAINT auau FOREIGN KEY (user_patient_id) REFERENCES ad_user_patient(user_patient_id);
...
ALTER TABLE ad_notification ADD CONSTRAINT ad_notification_prev_user_id_ad_user_user_id FOREIGN KEY (prev_user_id) REFERENCES ad_user(user_id);
ALTER TABLE ad_notification ADD CONSTRAINT ad_notification_patient_id_ad_patient_patient_id FOREIGN KEY (patient_id) REFERENCES ad_patient(patient_id);
ALTER TABLE ad_notification ADD CONSTRAINT ad_notification_new_user_id_ad_user_user_id FOREIGN KEY (new_user_id) REFERENCES ad_user(user_id);
