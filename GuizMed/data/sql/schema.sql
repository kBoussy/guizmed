...
CREATE TABLE ad_user_patient (user_patient_id INT AUTO_INCREMENT, patient_id INT NOT NULL, user_id INT NOT NULL, prev_user_id INT, INDEX patient_id_idx (patient_id), INDEX prev_user_id_idx (prev_user_id), INDEX user_id_idx (user_id), PRIMARY KEY(user_patient_id)) ENGINE = INNODB;
