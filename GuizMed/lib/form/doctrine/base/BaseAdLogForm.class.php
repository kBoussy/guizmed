...
abstract class BaseAdLogForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ad_user_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('AdUser'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'ad_user_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('AdUser'))),
